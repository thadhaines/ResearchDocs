...
\begin{document}
	\begin{tikzpicture}[auto, node distance=1cm,>=triangle 45]
		...
		% python
		\node [block, right=of user,] (python) {\shortstack{\textbf{Python} \\ Initializes simulation environment \\ Handles PSLF communication \\ Performs dynamic calculations\\ Logs data}};
