...
% 'legend'
\coordinate[below=0.5cm of PY3.south west] (est left);
...
\coordinate[below=0.5cm of PSLF.south west] (soln left);
...
\draw [->,magenta, ultra thick] ($(IPY.east)+ (0,0.4)$) -- ($(PSLF.west)+ (0,0.4)$);

\draw [<-, green, ultra thick]  ($(PY3.east)+ (0,-0.4)$) --  ($(IPY.west)+ (0,-0.4)$);
\draw [<-,green, ultra thick] ($(IPY.east)+ (0,-0.4)$) -- ($(PSLF.west)+ (0,-0.4)$);
