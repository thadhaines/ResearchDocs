...
\coordinate[below=1cm of PY3.south west] (est left);
...
\coordinate[below=0.75cm of est left] (soln left);
...
\draw [->, green, ultra thick] (soln left) -- (soln right);	
		...
		\draw [->, magenta, ultra thick] (PY3) -- (IPY);
		\draw [->,magenta, ultra thick] (IPY) -- (PSLF);
		
		\draw[->,green, ultra thick] (PSLF.south)  .. controls +(down:1cm) and +(down:1cm)
		.. ($(IPY.south)+ (0.5,0)$);
		\draw[->,green, ultra thick] ($(IPY.south)+ (-0.5,0)$)  .. controls +(down:1cm) and +(down:1cm)
		.. (PY3.south);
