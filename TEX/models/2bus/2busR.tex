...
\begin{document}
	...
	\coordinate[right = .5 of start] (sendingBus) {};
	\coordinate[right = 5 of sendingBus] (recBus) {};
	\coordinate[right = .5 of recBus] (end) {};
	...
	\draw (sendingBus) -- ($(sendingBus) +(1,0)$)
	to [R, l=$R$] ($(sendingBus) +(3,0)$) to [L, l=$jX$] (recBus);
